...
//==========================================================================
    ...
    public:
        void createAll()
        {
            ...
            createColorRegulator (sf::Color::Green, {0.7, 0.1}, \
            {0.1, 0.1} );
            //location = loc_canv + sz_canv - 2*sz_ColorReg.y_
            createColorRegulator (sf::Color::Red, {0.7, 0.1}, \
            {0.1, 0.3} );

            createColorRegulator (sf::Color::Yellow, {0.7, 0.1}, \
            {0.1, 0.5} );

            createColorRegulator (sf::Color::Blue, {0.7, 0.1}, \
            {0.1, 0.7} );
        }
